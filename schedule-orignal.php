															...
															<div class="tab-content schedule-cont">
																...
																<div id="slot_sunday" class="tab-pane fade">
																	<h4 class="card-title d-flex justify-content-between">
																		...
																		<a class="edit-link" data-toggle="modal" href="#add_time_slot" data-value="0"><i class="fa fa-plus-circle"></i> Add Slot</a></h4>

																		@php
																			$slot=ScheduleTimings::getSlot(0);
																		@endphp
																...
																<div id="slot_monday" class="tab-pane fade show active">
																	<h4 class="card-title d-flex justify-content-between">
																		<span>Time Slots</span> 
																		<a class="edit-link" data-toggle="modal" href="#add_time_slot" data-value="1"><i class="fa fa-plus-circle"></i> Add Slot</a>
																	</h4>
																	@php
																		...
																		<div class="user-times">
																			@foreach($slot as $row)
																		<div class="user-slot-list">
																			{{$row->start_time}} PM - {{$row->end_time}} PM
																			<a href="schedule-timings/delete/{{$row->slot_id}}" class="delete_schedule">
																				<i class="fa fa-times"></i>
																			</a>
																		</div>
