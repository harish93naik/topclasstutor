									...
									<div class="row">
										...
										<div class="col-12 blog-details">
											...
											<div class="d-flex flex-wrap date-col">
												...
												<span class="author"><i class="fe fe-user"></i> By <?php echo e($blog->admin_info->user->first_name); ?>&nbsp;<?php echo e($blog->admin_info->user->last_name); ?></span>
											</div>
											<div class="blog-details-img">
												<img class="img-fluid" src="<?php echo e(asset($blog->blog_image)); ?>" alt="Post Image">
											</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/admin/blog-details.blade.php ENDPATH**/ ?>