										...
										<div class="row form-row">
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="mentee_form[district]" class="form-control" value="<?php echo e($mentee_details->district); ?>">
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/mentee/profile-settings.blade.php ENDPATH**/ ?>