												...
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Gender</span>
															<div class="row-result"><?php echo e($mentee_details->gender); ?></div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															...
															<div class="row-result"><?php echo e($mentee_details->dob); ?></div>
														</div>
													</div>
												</li>
												<!-- <li>
											...
											<ul class="experience-list profile-custom-list">
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Address 1</span>
															<div class="row-result"><?php echo e($mentee_details->address1); ?></div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Address 2</span>
															<div class="row-result"><?php echo e($mentee_details->address2); ?></div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Country</span>
															<div class="row-result"><?php echo e($mentee_details->country); ?></div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>City</span>
															<div class="row-result"><?php echo e($mentee_details->city); ?></div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>State</span>
															<div class="row-result"><?php echo e($mentee_details->state); ?></div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															...
															<div class="row-result"><?php echo e($mentee_details->zipcode); ?></div>
														</div>
													</div>
												</li>
											</ul>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\template\resources\views/mentee/profile.blade.php ENDPATH**/ ?>