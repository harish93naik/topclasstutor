										...
										<ul>
											<li>
												<div class="post-author">
													<a href="profile"><img src="<?php echo e($row->mentor->user->profile_image); ?>" alt="Post Author"> <span><?php echo e($row->mentor->user->first_name); ?>&nbsp;<?php echo e($row->mentor->user->last_name); ?></span></a>
												</div>
											</li>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\template\resources\views/blog-list.blade.php ENDPATH**/ ?>