											...
											<div class="row">
												<div class="col-md-6 col-sm-12">
													<div class="form-group card-label">
														...
														<input class="form-control"  type="text" value="<?php echo e(auth()->user()->first_name); ?>">
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group card-label">
														<label>Phone</label>
														<input class="form-control" type="text" value="<?php echo e(auth()->user()->phone_number); ?>">
													</div>
												</div>
											</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/mentee/checkout.blade.php ENDPATH**/ ?>