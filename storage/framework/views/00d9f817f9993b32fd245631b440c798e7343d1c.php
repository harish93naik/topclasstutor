  ...
  <div>
    <div class="container">
        ...
        <div class="col-12 video-container" v-if="callPlaced">
          ...
          <div class="partner-video" v-else>
            <div v-if="callPartner" class="column items-center q-pt-xl">
              <div class="col q-gutter-y-md text-center">
                <p class="q-pt-md">
                  <strong><?php echo e(callPartner); ?></strong>
                </p>
                <p>calling...</p>
              </div>
            </div>
          ...
          <div class="action-btns">
            <button type="button" class="btn btn-info" @click="toggleMuteAudio">
              <?php echo e(mutedAudio ? "Unmute" : "Mute"); ?>
            ...
            >
              <?php echo e(mutedVideo ? "ShowVideo" : "HideVideo"); ?>
      ...
      <div class="row" v-if="incomingCallDialog">
        <div class="col">
          <p>
            Incoming Call From <strong><?php echo e(callerDetails.name); ?></strong>
          </p>
          <div class="btn-group" role="group">
            <button
              type="button"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\template\resources\views/video-chat.blade.php ENDPATH**/ ?>