										...
										<div class="row form-row">
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													...
													<input type="email" id="email" name="user_form[email]" class="form-control" value="<?php echo e($user_detail->email); ?>" onfocusout ='emailVerify()' onkeypress='emailMessageClear()'>
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="mentor_form[district]" class="form-control" value="<?php echo e($mentor_details->district); ?>">
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
