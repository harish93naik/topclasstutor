											...
											<div class="col-12 col-md-6 col-xl-4">
												<div class="course-box blog grid-blog">
													...
													<div class="course-content">
														...
														<div class="row">
															<div class="col">
																<a href="/admin/edit-blog/<?php echo e($row->blog_id); ?>" class="text-success"><i class="far fa-edit"></i> Edit</a>
															</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/admin/blog.blade.php ENDPATH**/ ?>