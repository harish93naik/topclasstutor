									...
									<div class="mentor-widget">
										<div class="user-info-left align-items-center">
											...
											<div class="user-info-cont">
												...
												<p class="mentor-type"><?php echo e($mentor->user->category_description); ?> (<?php echo e($mentor->user->degree); ?>)</p>
...
<div id="mentor-review-form" class="">
  <div style="display: flex">
  	...
  	<div style="padding-left: 40%;">
          ...
          <input type="hidden" id="mentor_id" name="mentor_id" value="<?php echo e($mentor->mentor_id); ?>">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\template\resources\views/profile.blade.php ENDPATH**/ ?>