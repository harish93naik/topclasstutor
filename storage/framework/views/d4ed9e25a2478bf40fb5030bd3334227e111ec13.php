						...
						<div class="col-lg-8 col-md-12">
							<div class="blog-view">
											...
											<ul>
												<li>
													<div class="post-author">
														<a href="profile"><img src="<?php echo e($blog->admin_info->user->profile_image); ?>" alt="Post Author"> <span><?php echo e($blog->admin_info->user->first_name); ?>&nbsp;<?php echo e($blog->admin_info->user->last_name); ?></span></a>
													</div>
												</li>
												<li><i class="far fa-calendar"></i><?php echo e($blog->created_at->format('M j, Y')); ?></li>
												<li><i class="far fa-comments"></i><?php $count = Blog::getCount($blog->blog_id)?>(<?php echo e($count); ?>)Comments</li>
												<li><i class="fa fa-tags"></i><?php echo e($blog->blog_category); ?></li>
											</ul>
										</div>
									</div>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="/profile/<?php echo e($blog->admin_info->admin_info_id); ?>"><img class="img-fluid rounded-circle" alt="" src="<?php echo e($blog->admin_info->user->profile_image); ?>"></a>
											</div>
										</div>
										<div class="author-details">
											<a href="/profile/<?php echo e($blog->admin_info->admin_info_id); ?>" class="blog-author-name"><?php echo e($blog->admin_info->user->first_name); ?>&nbsp;<?php echo e($blog->admin_info->user->last_name); ?></a>
								...
								<div class="card blog-comments clearfix">
									<div class="card-header">
										<h4 class="card-title"><?php $count = Blog::getCount($blog->blog_id)?>(<?php echo e($count); ?>)Comments</h4>
									</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/blog-details.blade.php ENDPATH**/ ?>