														...
														<tr>
															<td>
																<h2 class="table-avatar">
																	...
																	<a href="profile"><?php echo e($row->mentor->user->first_name); ?>&nbsp;<?php echo e($row->mentor->user->last_name); ?><span><?php echo e($row->mentor->user->email); ?></span></a>				
																</h2>
															</td>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\template\resources\views/mentee/dashboard-mentee.blade.php ENDPATH**/ ?>