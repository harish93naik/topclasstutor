	...
	<header class="header">
				...
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<?php if(Route::is(['pagee','mentor-register','mentee-register','about','login-topclasstutors'])): ?>
						<?php if(!auth()->user()): ?>
						<li class="mobile-menu-items <?php echo e(Request::is('mentee-register') ? 'active' : ''); ?>">
						<a  href="/mentee-register">Mentee Register</a>
						</li>
						<li class="mobile-menu-items <?php echo e(Request::is('mentor-register') ? 'active' : ''); ?>">
				...
				<!-- 	<div class="main-menu-wrapper">
					...
					<?php if(Route::is(['pagee','mentor-register','mentee-register','about','login-topclasstutors'])): ?>
						...
						<a class="nav-link header-login  home-menu <?php echo e(Request::is('mentee-register') ? 'active' : ''); ?>" href="/mentee-register">Mentee Register</a>
						

						<a class="nav-link header-login  home-menu <?php echo e(Request::is('mentor-register') ? 'active' : ''); ?>" href="/mentor-register">Become a Mentor?</a>
						...
						<?php endif; ?>
						<?php endif; ?>
						<?php if(!Route::is(['mentor-register','mentee-register'])): ?>
						<?php if(auth()->user()): ?>
						...
						<li class="nav-item dropdown has-arrow logged-item">
							...
							<div class="dropdown-menu dropdown-menu-right">
								...
								<a class="dropdown-item" href="/mentor/dashboard">Dashboard</a>
								<a class="dropdown-item" href="/mentor/profile-settings">Profile Settings</a>
								<?php elseif(auth()->user()->role=="mentee"): ?>
								<a class="dropdown-item" href="/mentee/dashboard">Dashboard</a>
								<a class="dropdown-item" href="/mentee/profile-settings">Profile Settings</a>
								<?php else: ?>
								<a class="dropdown-item" href="/admin/dashboard">Dashboard</a>
								<a class="dropdown-item" href="/admin/profile-settings">Profile Settings</a>
								<?php endif; ?>
...
<?php /**PATH G:\topclasstutor\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>