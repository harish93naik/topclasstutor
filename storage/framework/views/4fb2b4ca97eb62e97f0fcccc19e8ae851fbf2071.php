							...
							<div class="profile-sidebar">
								...
								<div class="custom-sidebar-nav">
									<ul>
										...
										<li><a href="/mentor/invoices" class="active"><i class="fas fa-file-invoice"></i>Invoices <span><i class="fas fa-chevron-right"></i></span></a></li>
									...
									<div class="table-responsive">
										<table class="table table-hover table-center mb-0">
											...
											<tbody>
												...
												<tr>
													<td>
														<a href="invoice-view">#INV-<?php echo e($row->invoice_id); ?></a>
													</td>
													<td>
														<h2 class="table-avatar">
															<a href="profile-mentee" class="avatar avatar-sm mr-2">
																<img class="avatar-img rounded-circle" src="<?php echo e(asset($row->booking->mentee->user->profile_image)); ?>" alt="User Image">
															</a>
															<a href="profile-mentee"><?php echo e($row->booking->mentee->user->first_name); ?>&nbsp;<?php echo e($row->booking->mentee->user->last_name); ?></a>
														</h2>
													</td>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/mentor/invoices.blade.php ENDPATH**/ ?>