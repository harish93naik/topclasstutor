							...
							<div class="profile-sidebar">
								<div class="user-widget">
									...
									<div class="user-info-cont">
										...
										<p class="mentor-type"><?php echo e($user_detail->category); ?>(<?php echo e($user_detail->degree); ?></p>
									</div>
								</div>
													...
													<div class="row">
														<div class="col-lg-12">
															<div class="form-group">
																...
																<input type="hidden" name="form[mentor_id]" value="<?php echo e($mentor_details->mentor_id); ?>">
															</div>
														</div>
													</div>
												</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\topclasstutor\resources\views/mentor/add-blog.blade.php ENDPATH**/ ?>