							...
							<div class="card">
								<div class="card-body custom-border-card pb-0">
									...
									<div class="widget about-widget custom-about mb-0">
										...
										<hr/>
										<p>{{$mentor_details->description}}</p>
									</div>
									<!-- /About Details -->
								</div>
							</div>
												...
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Gender</span>
															<div class="row-result">{{$mentor_details->gender}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															...
															<div class="row-result">{{$mentor_details->dob}}</div>
														</div>
													</div>
												</li>
												<!-- <li>
											...
											<ul class="experience-list profile-custom-list">
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Segment</span>
															<div class="row-result">{{$mentor_details->user->segment}}</div>
														</div>
													</div>
												</li>
												<!-- <li>
											...
											<ul class="experience-list profile-custom-list">
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Address 1</span>
															<div class="row-result">{{$mentor_details->address1}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Address 2</span>
															<div class="row-result">{{$mentor_details->address2}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Country</span>
															<div class="row-result">{{$mentor_details->country}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>City</span>
															<div class="row-result">{{$mentor_details->city}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Suburb</span>
															<div class="row-result">{{$mentor_details->state}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>District</span>
															<div class="row-result">{{$mentor_details->district}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															...
															<div class="row-result">{{$mentor_details->zipcode}}</div>
														</div>
													</div>
												</li>
											</ul>
