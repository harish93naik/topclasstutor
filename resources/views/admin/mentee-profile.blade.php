									...
									<div class="mentor-widget">
										<div class="user-info-left align-items-center">
											<div class="mentor-img d-flex flex-wrap justify-content-center">
												<div class="pro-avatar">{{$mentee->user->first_name[0]}}{{$mentee->user->last_name[0]}}</div>
												
												<div class="mentor-details m-0">
													<p class="user-location m-0"><i class="fas fa-map-marker-alt"></i> {{$mentee->state}}, {{$mentee->country}}</p>
												</div>
											</div>
											<div class="user-info-cont">
												<h4 class="usr-name">{{$mentee->user->first_name}}&nbsp;{{$mentee->user->last_name}}</h4>
												...
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Gender</span>
															<div class="row-result">{{$mentee->user->gender}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															...
															<div class="row-result">{{$mentee->dob}}</div>
														</div>
													</div>
												</li>
												<!-- <li>
											...
											<ul class="experience-list profile-custom-list">
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Address 1</span>
															<div class="row-result">{{$mentee->address1}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Address 2</span>
															<div class="row-result">{{$mentee->address2}}</div>
														</div>
													</div>
												</li>
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>Country</span>
															<div class="row-result">{{$mentee->country}}</div>
														</div>
													</div>
												</li>
												...
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															<span>City</span>
															<div class="row-result">{{$mentee->city}}</div>
														</div>
													</div>
												</li>
												<li>
												...
												<li>
													<div class="experience-content">
														<div class="timeline-content">
															...
															<div class="row-result">{{$mentee->zipcode}}</div>
														</div>
													</div>
												</li>
											</ul>
